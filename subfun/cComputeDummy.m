classdef cComputeDummy<cCompute %-%-%
    ...
    methods
        ...
        function oComp = mInit_oCompApp(oComp, oImgs, oCont)
            ...
            pAcfg = oCont.pAcfg;
            %-------------------------------%
            % sort images to oComp objects
            for i = 1:numel(oImgs)    % go through every slice
                indImg = i;
                ...
                imgstmp.name = 'DummyImage';
                imgstmp.nr = i;
                
                oComp(i).oImgs = imgstmp;
                oComp(i).pSliceLocation = i;
...
%                 case pAcfg.key.saveData
        ...
        function oComp = cComputeDummy(cCompArray) %-%-%
